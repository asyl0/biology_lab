            ...
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-white">{teachersMaterials.length}</p>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-white">
                    {teachersMaterials.filter(material => material.class_level === 7).length}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-white">
                    {teachersMaterials.filter(material => material.class_level === 8).length}
                  </p>
                </div>
              </div>
            </CardContent>
        ...
        {filteredMaterials.length === 0 && (
          <Card className="border-0 shadow-xl bg-white">
            <CardContent className="p-12 text-center">
              <GraduationCap className="h-16 w-16 text-emerald-400 mx-auto mb-6" />
