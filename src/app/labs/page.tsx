    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-cyan-50 to-emerald-50">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600">Зертханалық жұмыстар жүктелуде...</p>
        </div>
      </div>
    )
  }
          ...
          <Card className="border-0 shadow-xl bg-gradient-to-r from-emerald-500 to-cyan-500 text-white">
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-emerald-100">Барлық жұмыстар</p>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-white">
                    {labs.filter(lab => lab.class_level === 7).length}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-white">
                    {labs.filter(lab => lab.class_level === 8).length}
                  </p>
                </div>
              </div>
            </CardContent>
              ...
              <div className="aspect-video bg-gradient-to-br from-emerald-100 to-cyan-100 rounded-t-xl overflow-hidden">
                {lab.image_url ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-emerald-100 to-cyan-100">
                    <FlaskConical className="h-12 w-12 text-emerald-500" />
                  </div>
                )}
              </div>
              <CardContent className="p-6">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="font-bold text-lg line-clamp-2 text-gray-800">{lab.title}</h3>
                  <Badge className="bg-gradient-to-r from-emerald-500 to-cyan-500 text-white border-0 px-3 py-1 rounded-full">
                    {lab.class_level}-сынып
                  </Badge>
                </div>
        ...
        {filteredLabs.length === 0 && (
          <Card className="border-0 shadow-xl bg-white">
            <CardContent className="p-12 text-center">
              <FlaskConical className="h-16 w-16 text-emerald-400 mx-auto mb-6" />
